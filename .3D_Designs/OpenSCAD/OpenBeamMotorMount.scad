...
module base(t_thickness, slot_height=35) {
    ...
    difference () {
        ...
        // screw
        translate([m_width-(3.8/2),t_thickness/2,padded_height-thickness])
    ...
    union () {
      ...
      cube([extra_length, t_thickness, padded_height]);
      
      translate([padded_width+extra_length,0,0])
      cube([t_padded_width, t_thickness, padded_height/2]);
      
      
      translate([extra_length+padded_width,0,padded_height/2])
      t_slot_beam(slot_height, t_thickness);
   ...
   difference() {
     ...
     union() {
        ...
        // Plate connected to the motor shaft
         padded_length = (orientation == 1) ? mount_length+thickness : mount_length-1
         ;
        padded_width = mount_width+thickness*2;
     ...
     // screw
     translate([motor_width/2,motor_width/2,35])
        cylinder(3, d=3.8);
        
     //translate([motor_width/2-2,motor_width/2+9,-1])
